...
def add_book(request):
    if request.method == 'POST':
        ...
        if title and rating and comment:
            ...
            tit = book.title
            auth = book.author
            avr = book.average_rating
            num = book.total_numbers
            create_book(tit, auth, avr, num)
            book.save()
